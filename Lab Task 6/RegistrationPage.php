...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	if(isset($_POST["register"]))
	{
		...
		if($user['id']=='0')
		{
			...
			elseif(!preg_match("/[a-z][^ #!:$^&]{3,15}$/",$_POST["userName"]))
			{
				$userNameE="Must be of Length:3-15 and cannot contain '#!:$^&' ";
			}
			else
			{
...
<form action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST" enctype="multipart/form-data">
	...
	<table class="table">
		...
		<tr>
			...
			<td><input type="radio" name="type" id="teacher" value="teacher"><br></td>
			<td><label for="teacher">Teacher</label></td>
			<td><input type="radio" name="type" id="student" value="student"><br></td>
			<td><label for="client">Student</label></td>
			<td><input type="radio" name="type" id="librarian" value="librarian"><br></td>
			<td><label for="client">Librarian</label></td>
